  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", width: "100%", height: "50vh", overflow: "hidden" }}>
        ...
        {/* Top gradient */}
        <div className="absolute pointer-events-none" style={{ top: 0, left: 0, right: 0, height: 100, zIndex: 8, background: "linear-gradient(to bottom, rgba(0,0,0,0.35) 0%, rgba(0,0,0,0.10) 50%, transparent 100%)" }} />
