          ...
          <div className="medit-header" style={{ position: "relative" }}>
            {qrDataUrl && (
              <div style={{ position: "absolute", top: 0, right: 0, display: "flex", flexDirection: "column", alignItems: "center", gap: 3 }}>
                <div style={{ padding: 3, background: "rgba(47,93,138,0.08)", borderRadius: 4, border: "1px solid #2f5d8a" }}>
                  <img src={qrDataUrl} alt="QR" style={{ width: 44, height: 44, display: "block" }} />
                </div>
                <span style={{ fontSize: "5.5pt", color: "#2f5d8a", letterSpacing: "0.06em", textTransform: "uppercase", fontFamily: "'Marcellus', serif", textAlign: "center" }}>Ver carta QR</span>
              </div>
            )}
            {restaurant.logoUrl && (
