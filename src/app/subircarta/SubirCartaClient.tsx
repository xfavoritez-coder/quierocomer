            ...
            <div className="methods" data-track="Elegir metodo (link, foto, PDF, scratch)">
              {(["photo", "link", "pdf", "scratch"] as const).map((m) => (
                ...
                >
                  ...
                  {m === "scratch" && (
                    <><svg viewBox="0 0 64 64" fill="none"><path d="M32 12v40M12 32h40" stroke="currentColor" strokeWidth="3" strokeLinecap="round"/><rect x="14" y="14" width="36" height="36" rx="8" stroke="currentColor" strokeWidth="3"/></svg><strong>Crear de cero</strong><span>crea tu carta desde cero</span></>
                  )}
                </button>
              ))}
            </div>
