...
export default function CategoryNav({
  ...
  return (
    <nav
      ...
      style={{ position: "sticky", top: 0, background: "#ffffff", borderBottom: "1px solid #f0f0f0", height: 44, display: "flex", alignItems: "center", transform: "translateZ(0)", WebkitTransform: "translateZ(0)", marginTop: 10, marginBottom: 6 }}
    >
      {leftSlot && (
