/**
 * Busca restaurantes en Algarrobo con Google Places API,
 * filtra los que tienen website con menú extraíble,
 * y los importa a QuieroComer usando el pipeline de extracción.
 *
 * Uso: npx ts-node --skip-project scripts/importar-algarrobo.ts
 */
...
// ─── Main ──────────────────────────────────────────────────────
async function main() {
  console.log('🔍 Buscando restaurantes en Algarrobo, Chile...\n')

  const queries = [
    'restaurantes en Algarrobo, Chile',
    'cafeterías en Algarrobo, Chile',
    'comida en Algarrobo, Chile',
    'heladerías en Algarrobo, Chile',
    'pizzerías en Algarrobo, Chile',
    'sushi en Algarrobo, Chile',
    'marisquerías en Algarrobo, Chile',
    'comida rápida en Algarrobo, Chile',
  ]
