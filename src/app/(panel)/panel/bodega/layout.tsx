...
/**
 * Guard del pilar Bodega. Solo se muestra a restaurantes que el
 * superadmin habilitó (bodegaEnabled). El sidebar ya oculta el menú,
...
export default function BodegaLayout({ children }: { children: React.ReactNode }) {
  ...
  const enabled = !!(selected as any)?.bodegaEnabled;
    ...
    return (
      <div style={{ maxWidth: 520, margin: "60px auto", padding: "0 20px", textAlign: "center" }}>
        <div style={{ width: 64, height: 64, borderRadius: 18, background: "var(--adm-hover)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 20px" }}>
          <Warehouse size={30} color="var(--adm-text3)" />
        </div>
