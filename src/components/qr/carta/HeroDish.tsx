        ...
        <div className="flex items-center" style={{ gap: 8 }}>
          {onSearchClick && (
            <button
              ...
              style={{ width: 46, height: 46, borderRadius: "50%", background: "var(--carta-search-bg)", display: "flex", alignItems: "center", justifyContent: "center", border: "none", cursor: "pointer" }}
              aria-label="Buscar"
            >
              <Search size={21} color="var(--carta-text2)" />
            </button>
          )}
