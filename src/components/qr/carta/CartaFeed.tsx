      ...
      <div style={{ padding: "12px 16px 14px", display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }}>
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", flexWrap: "wrap", gap: 6, marginBottom: 4 }}>
            ...
            {isNew && (
              <span style={{ display: "inline-block", background: "#1a1a1a", color: "#fff", fontSize: 9, fontWeight: 600, padding: "2px 6px", borderRadius: 4, letterSpacing: "0.3px", verticalAlign: "middle" }}>
              ...
              <div ref={catScrollRef} className="hide-scrollbar" style={{ display: "flex", gap: 6, overflowX: "auto", flex: 1, scrollbarWidth: "none" }}>
                {hasPromos && (
                  <button
                    ...
                    style={{ padding: "7px 12px", borderRadius: 999, border: "none", cursor: "pointer", fontSize: 12, fontWeight: activeCategory === "promos" ? 500 : 400, whiteSpace: "nowrap", background: activeCategory === "promos" ? "#1a1a1a" : "#F5F4F1", color: activeCategory === "promos" ? "#fff" : "#5a5a5a" }}
                  >
                ...
                {categories.map(cat => (
                  <button
                    ...
                    style={{
                      ...
                      background: activeCategory === cat.id ? "#1a1a1a" : "#F5F4F1",
