...
Reglas dishType:
- "combo" SOLO cuando el nombre o descripción indica claramente que es un conjunto de productos distintos (plato principal + bebida, plato + postre, varios platos juntos). Señales claras: "combo", "pack", "promo", "colación", "box", "menú del día", "duo", "trio", "para X personas", "+bebida", "+postre" en el nombre. Una hamburguesa, sándwich o plato que venga descrito con papas fritas o ensalada como guarnición/acompañamiento NO es combo — es solo el plato principal. Si hay duda, NO incluyas "combo". Cuando es un combo, incluye "combo" + el tipo del plato principal (ej: ["combo","hamburguesa"]). NUNCA incluir "papas fritas" en dishType cuando aparece solo como guarnición.
