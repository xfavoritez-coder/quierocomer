        ...
        >
          {logoSrc ? (
            ...
            <div
              ...
              style={{ width: 28, height: 28, background: "#F4A623", fontSize: "0.7rem", fontWeight: 700, color: "#0e0e0e" }}
            >
              {initial}
            </div>
          )}
          <span
            ...
            style={{ fontSize: "1.17rem", fontWeight: 400, textShadow: "0 1px 3px rgba(0,0,0,0.4)", opacity: 0.85 }}
          >
            {restaurant.name}
          </span>
        </button>
