          ...
          <div style={{
            ...
            <nav style={{ flex: 1, padding: '6px 8px', display: 'flex', flexDirection: 'column', gap: 1 }}>
              ...
              <a href="/qr" style={{
                ...
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#F4A623" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
                  <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>
                </svg>
                <div>
                  <div style={{ fontSize: 15, fontWeight: 600, color: '#F4A623' }}>¿Tienes un local?</div>
                  <div style={{ fontSize: 12, color: isDark ? 'rgba(255,255,255,0.35)' : 'rgba(0,0,0,0.38)', marginTop: 1 }}>Súbete a QuieroComer</div>
                </div>
              </a>
