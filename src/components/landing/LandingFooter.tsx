      ...
      <footer className="lf-footer">
        <div className="lf-footer-inner">
          <div className="lf-footer-top">
            ...
            <div className="lf-footer-col">
              ...
              <div className="lf-footer-col-links">
                <a href="/carta-qr" className="lf-footer-link">{t("footer_qr")}</a>
                <a href="/fidelizacion" className="lf-footer-link">{t("footer_loyalty")}</a>
                <a href="/#precios" className="lf-footer-link">{t("footer_pricing")}</a>
                <a href="/panel/login" className="lf-footer-link">{t("footer_panel")}</a>
              </div>
            </div>
            <div className="lf-footer-col">
          ...
          <div className="lf-footer-bottom">
            <span className="lf-footer-copy">{t("footer_copy")}</span>
            <span className="lf-footer-badge">{t("footer_badge")}</span>
          </div>
        </div>
      </footer>
    </>
