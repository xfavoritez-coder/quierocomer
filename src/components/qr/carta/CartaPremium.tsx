      ...
      <div className="fixed z-50 flex flex-col items-end" style={{ right: 14, bottom: "calc(54px + env(safe-area-inset-bottom))", gap: 10 }}>
        <div style={{ position: "relative" }}>
          ...
          <button
            ...
            style={{ height: 52, width: 52, background: "#E8B828", boxShadow: (showGenioNudge || showLikeGenioTip) ? "0 0 0 4px rgba(232,184,40,0.3), 0 4px 18px rgba(232,184,40,0.35)" : "0 4px 18px rgba(232,184,40,0.35)", borderRadius: 50, transition: "all 0.3s ease", position: "relative" }}
          >
