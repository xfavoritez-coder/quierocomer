...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    body: "Tienes 3 vistas. Esta se llama \"Galería\", muestra tu carta con fotos en carrusel y los poderes de una QR inteligente.",
    showOverlay: false,
    buttonLabel: "Siguiente",
  },
  {
...
export default function DemoOnboarding({ restaurantSlug, onboardingDone, allPhotosReferential, hasReferentialPhotos, showcaseMode, restaurantName }: Props) {
  ...
  const current = showcaseMode ? {
    ...
    ...(step === 2 && { title: "Vista Galería", body: "Tienes 3 vistas, esta se llama \"Galería\", muestra tu carta con fotos en carrusel y los poderes de una carta QR inteligente." }),
