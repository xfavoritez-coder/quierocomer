...
export const PLANS: Record<PlanKey, PlanDef> = {
  FREE: {
    ...
    featureDisplay: [
      ...
      { text: "Genio IA incluido", tip: "El Genio reordena tu carta segun los gustos de cada cliente." },
  ...
  SILVER: {
    ...
    features: new Set([
      ...
      "highlight_dishes", "promotions", "announcements", "stats_basic",
    ]),
    featureDisplay: [
      ...
      { text: "Destacar platos estrella", tip: "Resalta visualmente los platos que mas te conviene vender." },
      ...
      { text: "Estadisticas basicas", tip: "Visitas, platos mas vistos y duracion promedio." },
    ],
  ...
  GOLD: {
    ...
    featureDisplay: [
      { text: "Estadisticas avanzadas", tip: "Sesiones en vivo, recorrido de cada cliente, busquedas." },
      { text: "Multilenguaje (ES / EN / PT)", tip: "Tu carta se traduce automaticamente." },
  ...
  PREMIUM: {
    ...
    featureDisplay: [
      ...
      { text: "Idiomas adicionales", tip: "Agrega idiomas extra ademas de ingles y portugues: frances, italiano, aleman, chino y mas." },
    ],
