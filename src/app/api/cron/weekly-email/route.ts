...
export async function GET(req: NextRequest) {
  ...
  // Email semanal desactivado temporalmente
  return NextResponse.json({ ok: true, sent: 0, disabled: true });
}

// eslint-disable-next-line @typescript-eslint/no-unused-vars
async function _weeklyEmailImpl(req: NextRequest) {
  const start = Date.now();

  // Insights are pre-generated by the Sunday cron (/api/cron/generate-insights).
  // This cron only handles email sending.
