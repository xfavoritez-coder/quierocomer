                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                        ...
                        {s.dish.tags?.includes("RECOMMENDED") && <span style={{ fontSize: "0.66rem", fontWeight: 600, padding: "2px 6px", borderRadius: 4, background: "rgba(244,166,35,0.2)", color: "#fbbf24", flexShrink: 0 }}>⭐ Recomendado</span>}
                        {popularDishIds?.has(s.dish.id) && <span style={{ fontSize: "0.66rem", fontWeight: 600, padding: "2px 6px", borderRadius: 4, background: "rgba(239,68,68,0.15)", color: "#f87171", flexShrink: 0 }}>🔥 Popular hoy</span>}
                      </div>
                      {s.dish.description && (
