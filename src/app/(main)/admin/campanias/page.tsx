    ...
    <div style={{ maxWidth: 800 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24 }}>
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <RestaurantPicker />
          {!creating && <button onClick={() => setCreating(true)} style={{ padding: "8px 16px", background: "#F4A623", color: "#0a0a0a", border: "none", borderRadius: 8, fontFamily: F, fontSize: "0.82rem", fontWeight: 700, cursor: "pointer" }}>+ Nueva campaña</button>}
        </div>
      </div>
