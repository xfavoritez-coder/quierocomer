...
import { autoMapRestaurantModifiers } from "@/lib/toteat/mapping";

/**
 * Auto-map every unmapped ModifierTemplateOption against Toteat product names.
 * Used to map per-flavor codes (HV0301 Limonada Menta, HV0302 Limonada Jengibre)
 * back to a parent dish like "Limonada Artesanal".
 *
...
export async function POST(req: NextRequest) {
  ...
  const results = await autoMapRestaurantModifiers(restaurantId, { force });
