...
const I18N = {
  es: {
    ...
    microcopy: "",
    heroTitle: "Crea una carta imprimible + QR inteligente que {vende más} por ti",
  ...
  en: {
    ...
    microcopy: "",
    heroTitle: "Create a printable menu + smart QR that {sells more} for you",
    heroSubtitle: "Increase your sales and improve your customers' experience.",
    heroCta: "Create menu for free",
    ...
    funciones: [
      ...
      { icon: "🖨️", title: "Export your printed menu", desc: "Download your menu as a professionally designed PDF ready to print. In Spanish, English or Portuguese." },
    ],
...
.lamp-icon{height:20px;width:auto;margin-right:-8px;object-fit:contain}
...
.hero h1{font-size:clamp(38px,5.5vw,82px);line-height:1.02;max-width:620px;margin-left:auto;margin-right:auto;margin-bottom:28px;font-weight:400}
