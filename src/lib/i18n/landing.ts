...
const es = {
  ...
  restaurants_label: "Restaurantes que ya usan QuieroComer",
  ...
  plan_addon: "Módulo adicional",
  plan_loyalty: "Loyalty",
...
const en: typeof es = {
  ...
  // Home restaurants section
  restaurants_label: "Restaurants already using QuieroComer",
