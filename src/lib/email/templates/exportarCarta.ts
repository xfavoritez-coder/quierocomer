...
<table width="520" cellpadding="0" cellspacing="0" border="0" style="max-width:520px;width:100%;">
  ...
  <tr><td align="center" style="padding-bottom:10px;">
    <p style="margin:0;font-size:15px;color:#666;line-height:1.6;">
      Hola ${firstName} — ahora puedes exportar la carta de <strong style="color:#1a1a1a;">${restaurantName}</strong><br>en 4 distintos diseños, e incluye el código QR de tu carta.
    </p>
  </td></tr>
